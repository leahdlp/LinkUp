...
user0.photo.attach(io: File.open("app/assets/images/users/tyrone.jpg"), filename: "tyrone.jpg")
user1.photo.attach(io: File.open("app/assets/images/users/anthony.jpg"), filename: "anthony.jpg")
user2.photo.attach(io: File.open("app/assets/images/users/sis.jpg"), filename: "eddie.jpg")
user3.photo.attach(io: File.open("app/assets/images/users/eddie3.jpeg"), filename: "eddie3.jpeg")
user4.photo.attach(io: File.open("app/assets/images/users/sis.jpg"), filename: "sis.jpg")
user5.photo.attach(io: File.open("app/assets/images/users/cmac.jpg"), filename: "cmac.jpg")
user6.photo.attach(io: File.open("app/assets/images/users/solo-girl.jpg"), filename: "kquan.jpg")
user7.photo.attach(io: File.open("app/assets/images/users/solo-girl.jpg"), filename: "sasha.jpg")
user8.photo.attach(io: File.open("app/assets/images/users/sis.jpg"), filename: "kojo.jpg")
user9.photo.attach(io: File.open("app/assets/images/users/sis.jpg"), filename: "mj.jpg")
user10.photo.attach(io: File.open("app/assets/images/users/rapsody.jpg"), filename: "rapsody.jpg")
user11.photo.attach(io: File.open("app/assets/images/users/gyptian.jpg"), filename: "windel.jpg")
user12.photo.attach(io: File.open("app/assets/images/users/2chainz.jpg"), filename: "2chainz.jpg")
user13.photo.attach(io: File.open("app/assets/images/users/wayne.jpg"), filename: "wayne.jpg")
user14.photo.attach(io: File.open("app/assets/images/users/meg.jpg"), filename: "meg.jpg")
user15.photo.attach(io: File.open("app/assets/images/users/cardi.jpg"), filename: "cardi.jpg")
user16.photo.attach(io: File.open("app/assets/images/users/maryD.jpg"), filename: "maryD.jpg")
user17.photo.attach(io: File.open("app/assets/images/users/abdul.jpg"), filename: "abdul.jpg")
user18.photo.attach(io: File.open("app/assets/images/users/jasonB.jpeg"), filename: "jasonB.jpeg")
user19.photo.attach(io: File.open("app/assets/images/users/bruno.jpg"), filename: "bruno.jpg")
user20.photo.attach(io: File.open("app/assets/images/users/tobe.jpg"), filename: "tobe.jpg")
user21.photo.attach(io: File.open("app/assets/images/users/jabari.jpeg"), filename: "jabari.jpeg")
user22.photo.attach(io: File.open("app/assets/images/users/gavin.jpg"), filename: "gavin.jpg")
user23.photo.attach(io: File.open("app/assets/images/users/marvinS.jpeg"), filename: "marvinS.jpeg")
user24.photo.attach(io: File.open("app/assets/images/users/tanerelle.jpg"), filename: "tanerelle.jpg")
user25.photo.attach(io: File.open("app/assets/images/users/kirby.jpg"), filename: "kirby.jpg")
user26.photo.attach(io: File.open("app/assets/images/users/erykah.jpg"), filename: "erykah.jpg")
user27.photo.attach(io: File.open("app/assets/images/users/jilly.jpg"), filename: "jilly.jpg")
user28.photo.attach(io: File.open("app/assets/images/users/patrice.jpg"), filename: "patricia.jpg")
user29.photo.attach(io: File.open("app/assets/images/users/evelyn.jpg"), filename: "evelyn.jpg")
user30.photo.attach(io: File.open("app/assets/images/users/chika.jpg"), filename: "chika.jpg")
user31.photo.attach(io: File.open("app/assets/images/users/jorja.jpg"), filename: "jorja.jpg")
user32.photo.attach(io: File.open("app/assets/images/users/charmayne.jpg"), filename: "charmaynee.jpg")
user33.photo.attach(io: File.open("app/assets/images/users/nicci.jpg"), filename: "nicci.jpg")
user34.photo.attach(io: File.open("app/assets/images/users/rico.jpg"), filename: "rico.jpg")
user35.photo.attach(io: File.open("app/assets/images/users/sis.jpg"), filename: "kimberly.jpg")
user36.photo.attach(io: File.open("app/assets/images/users/wale.jpg"), filename: "wale.jpg")
user37.photo.attach(io: File.open("app/assets/images/users/nipsey.jpeg"), filename: "nipsey.jpeg")
user38.photo.attach(io: File.open("app/assets/images/users/kobe.jpg"), filename: "kobe.jpg")
user39.photo.attach(io: File.open("app/assets/images/users/sean.jpg"), filename: "sean.jpg")
user40.photo.attach(io: File.open("app/assets/images/users/rihanna.jpg"), filename: "rihanna.jpg")
user41.photo.attach(io: File.open("app/assets/images/users/diamonte.jpeg"), filename: "diamonte.jpeg")
user42.photo.attach(io: File.open("app/assets/images/users/youngMA.jpg"), filename: "youngMA.jpg")
user43.photo.attach(io: File.open("app/assets/images/users/wiz.jpg"), filename: "wiz.jpg")
user44.photo.attach(io: File.open("app/assets/images/users/AI.jpg"), filename: "AI.jpg")
user45.photo.attach(io: File.open("app/assets/images/users/tmac.jpg"), filename: "tmac.jpg")
user46.photo.attach(io: File.open("app/assets/images/users/paul.jpg"), filename: "paul.jpg")
user47.photo.attach(io: File.open("app/assets/images/users/KG.jpg"), filename: "KG.jpg")
user48.photo.attach(io: File.open("app/assets/images/users/CP3.jpg"), filename: "CP3.jpg")
user49.photo.attach(io: File.open("app/assets/images/users/d-wade.jpg"), filename: "d-wade.jpg")
user50.photo.attach(io: File.open("app/assets/images/users/gabs.jpg"), filename: "gabs.jpg")
user51.photo.attach(io: File.open("app/assets/images/users/angela.jpg"), filename: "angela.jpg")
user52.photo.attach(io: File.open("app/assets/images/users/courtneyB.jpg"), filename: "courtneyB.jpg")
user53.photo.attach(io: File.open("app/assets/images/users/danai.jpg"), filename: "danai.jpg")
user54.photo.attach(io: File.open("app/assets/images/users/lupita.jpg"), filename: "lupita.jpg")
user55.photo.attach(io: File.open("app/assets/images/users/laurence.jpg"), filename: "lawrence.jpg")
user56.photo.attach(io: File.open("app/assets/images/users/taye.png"), filename: "taye.png")
user57.photo.attach(io: File.open("app/assets/images/users/paula.jpg"), filename: "paula.jpg")
user58.photo.attach(io: File.open("app/assets/images/users/nia.jpeg"), filename: "nia.jpeg")
user59.photo.attach(io: File.open("app/assets/images/users/loretta.jpg"), filename: "loretta.jpg")
user60.photo.attach(io: File.open("app/assets/images/users/reginaK.jpeg"), filename: "reginaK.jpeg")
user61.photo.attach(io: File.open("app/assets/images/users/reginaH.jpg"), filename: "reginaH.jpg")
user62.photo.attach(io: File.open("app/assets/images/users/jackee.jpg"), filename: "jackee.jpg")
user63.photo.attach(io: File.open("app/assets/images/users/robinT.jpg"), filename: "robinT.jpg")
user64.photo.attach(io: File.open("app/assets/images/users/quinta.jpg"), filename: "quinta.jpg")
user65.photo.attach(io: File.open("app/assets/images/users/gabrielleD.jpg"), filename: "gabrielleD.jpg")
user66.photo.attach(io: File.open("app/assets/images/users/ashley.png"), filename: "ashley.png")
user67.photo.attach(io: File.open("app/assets/images/users/wendy.jpg"), filename: "wendy.jpg")
user68.photo.attach(io: File.open("app/assets/images/users/kimF.jpg"), filename: "kimF.jpg")
user69.photo.attach(io: File.open("app/assets/images/users/queenLatifah.jpg"), filename: "queenLatifah.jpg")
user70.photo.attach(io: File.open("app/assets/images/users/kimC.jpg"), filename: "kimC.jpg")
user71.photo.attach(io: File.open("app/assets/images/users/erika.jpg"), filename: "erika.jpg")
user72.photo.attach(io: File.open("app/assets/images/users/jada.jpg"), filename: "jada.jpg")
user73.photo.attach(io: File.open("app/assets/images/users/goldlink.jpg"), filename: "goldlink.jpg")
user74.photo.attach(io: File.open("app/assets/images/users/jidenna.jpg"), filename: "jidenna.jpg")
user75.photo.attach(io: File.open("app/assets/images/users/jamila.jpg"), filename: "jamila.jpg")
user76.photo.attach(io: File.open("app/assets/images/users/burna.jpg"), filename: "burna.jpg")
user77.photo.attach(io: File.open("app/assets/images/users/fela.jpg"), filename: "fela.jpg")
user78.photo.attach(io: File.open("app/assets/images/users/luther.png"), filename: "luther.png")
user79.photo.attach(io: File.open("app/assets/images/users/anthonyH.jpeg"), filename: "anthonyH.jpeg")
user80.photo.attach(io: File.open("app/assets/images/users/laz.png"), filename: "laz.png")
user81.photo.attach(io: File.open("app/assets/images/users/jean.jpg"), filename: "jean.jpg")
user82.photo.attach(io: File.open("app/assets/images/users/johnC.jpg"), filename: "johnC.jpg")
user83.photo.attach(io: File.open("app/assets/images/users/victorC.jpeg"), filename: "victorC.jpeg")
user84.photo.attach(io: File.open("app/assets/images/users/dave.jpg"), filename: "dave.jpg")
user85.photo.attach(io: File.open("app/assets/images/users/lefteye.jpg"), filename: "lefteye.jpg")
user86.photo.attach(io: File.open("app/assets/images/users/amara.jpg"), filename: "amara.jpg")
user87.photo.attach(io: File.open("app/assets/images/users/miguel.jpeg"), filename: "miguel.jpeg")
user88.photo.attach(io: File.open("app/assets/images/users/milian.jpeg"), filename: "milian.jpeg")
user89.photo.attach(io: File.open("app/assets/images/users/soledad.jpeg"), filename: "soledad.jpeg")
user90.photo.attach(io: File.open("app/assets/images/users/rosie.jpg"), filename: "rosie.jpg")
user91.photo.attach(io: File.open("app/assets/images/users/mos.jpg"), filename: "mos.jpg")
user92.photo.attach(io: File.open("app/assets/images/users/mahershala.jpg"), filename: "mahershala.jpg")
user93.photo.attach(io: File.open("app/assets/images/users/neelam.jpeg"), filename: "neelam.jpeg")
user94.photo.attach(io: File.open("app/assets/images/users/krissah.jpeg"), filename: "krissah.jpeg")
user95.photo.attach(io: File.open("app/assets/images/users/madeline.jpg"), filename: "madeline.jpg")
user96.photo.attach(io: File.open("app/assets/images/users/arthell.jpg"), filename: "arthell.jpg")
user97.photo.attach(io: File.open("app/assets/images/users/mjR.jpg"), filename: "mjR.jpg")
user98.photo.attach(io: File.open("app/assets/images/users/indya.jpg"), filename: "indya.jpg")
user99.photo.attach(io: File.open("app/assets/images/users/dominique.jpg"), filename: "dominique.jpg")
user100.photo.attach(io: File.open("app/assets/images/users/angelica.jpg"), filename: "angelica.jpg")
user101.photo.attach(io: File.open("app/assets/images/users/janetM.jpg"), filename: "janetM.jpg")
user102.photo.attach(io: File.open("app/assets/images/users/billy.jpg"), filename: "billy.jpg")
user103.photo.attach(io: File.open("app/assets/images/users/maxwell.jpg"), filename: "maxwell.jpg")
user104.photo.attach(io: File.open("app/assets/images/users/dangelo.jpg"), filename: "dangelo.jpg")
...
group1.photo.attach(io: File.open("app/assets/images/groups/white-dress-color-background.jpg"), filename: "art-in-public-spaces.jpg")
group2.photo.attach(io: File.open("app/assets/images/groups/open-mic.jpg"), filename: "oakland-queer-trans-open-mic.jpg")
group3.photo.attach(io: File.open("app/assets/images/groups/film.jpg"), filename: "bay-area-film-fans.jpg")
group4.photo.attach(io: File.open("app/assets/images/groups/fahamu.jpeg"), filename: "understanding-modern-contemp-art.jpeg")
group5.photo.attach(io: File.open("app/assets/images/groups/pottery.jpg"), filename: "earthfire-arts.jpg")
group6.photo.attach(io: File.open("app/assets/images/groups/art-tribe.jpg"), filename: "art-tribe.jpg")
group7.photo.attach(io: File.open("app/assets/images/groups/arts-tech.png"), filename: "arts-tech-philly.png")
group8.photo.attach(io: File.open("app/assets/images/groups/pottery-painting.jpg"), filename: "pottery-painting.jpg")
group9.photo.attach(io: File.open("app/assets/images/groups/workshop.jpg"), filename: "improv-acting-comedy-workshop.jpg")
group10.photo.attach(io: File.open("app/assets/images/groups/sketch.jpg"), filename: "sunday-sketchers-houston.jpg")
group11.photo.attach(io: File.open("app/assets/images/groups/reading.jpeg"), filename: "houston-queer-book-club.jpeg")
group12.photo.attach(io: File.open("app/assets/images/groups/writing.jpeg"), filename: "houston-authors.jpeg")
group13.photo.attach(io: File.open("app/assets/images/groups/library.jpeg"), filename: "atl-book-love.jpeg")
group14.photo.attach(io: File.open("app/assets/images/groups/sip-read.jpg"), filename: "sip-and-read.jpg")
group15.photo.attach(io: File.open("app/assets/images/groups/sulwe.jpeg"), filename: "atl-mindful-moms.jpeg")
group16.photo.attach(io: File.open("app/assets/images/groups/red-book.jpeg"), filename: "cocoa-risers-reading.jpeg")
group17.photo.attach(io: File.open("app/assets/images/groups/open-book.jpg"), filename: "classics-culture.jpg")
group18.photo.attach(io: File.open("app/assets/images/groups/brunch.jpg"), filename: "books-babes-brunch.jpg")
group19.photo.attach(io: File.open("app/assets/images/groups/womanist.jpeg"), filename: "intersectional-charlotte-feminist-books.jpeg")
group20.photo.attach(io: File.open("app/assets/images/groups/wine.jpeg"), filename: "melanin-wine.jpeg")
group21.photo.attach(io: File.open("app/assets/images/groups/social-media.jpg"), filename: "miami-social-media-marketing.jpg")
group22.photo.attach(io: File.open("app/assets/images/groups/white-background-color-clothes.jpg"), filename: "right-kind-of-black-girl.jpg")
group23.photo.attach(io: File.open("app/assets/images/groups/awkward.jpg"), filename: "awkward-black-tribe.jpg")
group24.photo.attach(io: File.open("app/assets/images/groups/testers.jpeg"), filename: "testers.jpeg")
...
event1.photo.attach(io: File.open("app/assets/images/events/fandom.jpg"), filename: "understanding-fandoms.jpg")
event2.photo.attach(io: File.open("app/assets/images/events/suit-laptop.jpeg"), filename: "excellence-in-tech.jpeg")
event3.photo.attach(io: File.open("app/assets/images/events/blm.jpg"), filename: "blm-discussions.jpg")
event4.photo.attach(io: File.open("app/assets/images/events/meeting-color.jpg"), filename: "fix-CSS-tabs.jpg")
event5.photo.attach(io: File.open("app/assets/images/events/screen_view.jpg"), filename: "fix-member-list.jpg")
event6.photo.attach(io: File.open("app/assets/images/events/working.jpeg"), filename: "fix-entity-form-speed.jpeg")
event7.photo.attach(io: File.open("app/assets/images/events/laptop-wrists.jpeg"), filename: "finish-nav-search-bar.jpeg")
event8.photo.attach(io: File.open("app/assets/images/events/laptop-side-view.jpeg"), filename: "fix-pink-button-text-alignment.jpeg")
event9.photo.attach(io: File.open("app/assets/images/events/laptop-landing.jpeg"), filename: "add-search-to-landing.jpeg")
event10.photo.attach(io: File.open("app/assets/images/events/laptop-from-top.jpeg"), filename: "integrate-aws.jpeg")
