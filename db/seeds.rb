...
member22 = Member.create!({ user_id: user3.id, group_id: group3.id })
member23 = Member.create!({ user_id: user3.id, group_id: group4.id })
member24 = Member.create!({ user_id: user3.id, group_id: group5.id })
member25 = Member.create!({ user_id: user3.id, group_id: group6.id })
member26 = Member.create!({ user_id: user3.id, group_id: group7.id })
member27 = Member.create!({ user_id: user3.id, group_id: group1.id })
member28 = Member.create!({ user_id: user3.id, group_id: group3.id })
member29 = Member.create!({ user_id: user3.id, group_id: group3.id })
member30 = Member.create!({ user_id: user3.id, group_id: group4.id })
member31 = Member.create!({ user_id: user3.id, group_id: group5.id })
member32 = Member.create!({ user_id: user3.id, group_id: group6.id })
member33 = Member.create!({ user_id: user3.id, group_id: group7.id })
